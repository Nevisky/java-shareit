...
public interface BookingService {
    ...
    Collection<BookingResponse> getAllUsersBookingByState(Long userId, String state);

    Collection<BookingResponse> getAllBookingsForItemsOfUser(Long userId, String state);
